...
function Meditacion() {
  ...
  return (
    ...
    <div className="container">
            ...
            <h6 className="task2 mt-4"> <span className="task">Bebe agua suficiente</span> <span className="time ml-2">8:00-8:30AM</span> <span className="float-right">30min</span> <p className="ml-4">Ayuda a tus musculos a trabajar eficientemente</p></h6>
            <h6 className="task2 mt-4"> <span className="task">Correr</span> <span className="time ml-2">8:00-8:30AM</span> <span className="float-right">1hr</span> <p className="ml-4">Manten la velocidad del ritmo</p></h6>
            <h6 className="task2 mt-4"> <span className="task">Preparate la ropa para mañana</span> <span className="time ml-2">8:00-8:30AM</span> <span className="float-right">30min</span> <p className="ml-4">Haz que tu mañana vaya como la seda</p></h6>
